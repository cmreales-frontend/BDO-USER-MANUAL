    ...
    <div className="content-section">
      <div className="subsection">
        ...
        <div style={accordionContainerStyle}>
          ...
          <div>
            <div style={accordionHeaderStyle(isViewProfileOpen)} onClick={() => setIsViewProfileOpen(!isViewProfileOpen)}>
              <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Go to User Information (Profile):</span>
              <span style={chevronStyle(isViewProfileOpen)}>&#8964;</span>
            </div>
            {isViewProfileOpen && (
          ...
          <div>
            <div style={{ ...accordionHeaderStyle(isChangePasswordOpen), borderBottom: isChangePasswordOpen ? '1px solid #ddd' : 'none' }} onClick={() => setIsChangePasswordOpen(!isChangePasswordOpen)}>
              <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Change User Password:</span>
              <span style={chevronStyle(isChangePasswordOpen)}>&#8964;</span>
            </div>
              ...
              <div style={{ ...accordionBodyStyle, borderBottom: 'none' }}>
                <ol style={{ paddingLeft: "40px" }}>
                  ...
                  <li style={{ marginBottom: "1px" }}>
                    ...
                    <button style={{ backgroundColor: "#ffc107", color: "#000", border: "1px solid #ccc", padding: "2px 6px", borderRadius: "4px", cursor: "pointer" }}>Generate</button>{' '}
                    button to generate random password.
                  </li>
                  <li style={{ marginBottom: "1px" }}>
                    Click{' '}
                    <button style={{ backgroundColor: "#ffc107", color: "#000", border: "1px solid #ccc", padding: "2px 6px", borderRadius: "4px", cursor: "pointer" }}>Update</button>{' '}
                    button to submit the transaction. A confirmation dialog box is displayed. Click{' '}
                    <button style={{ backgroundColor: "#ffc107", color: "#000", border: "1px solid #ccc", padding: "2px 6px", borderRadius: "4px", cursor: "pointer" }}>Yes</button>{' '}
                    to continue and{' '}
                    <button style={{ backgroundColor: "#ffc107", color: "#000", border: "1px solid #ffc107", padding: "2px 6px", borderRadius: "4px", cursor: "pointer" }}>No</button>{' '}
                    if otherwise.
                  </li>
                  <li style={{ marginBottom: "1px" }}>
