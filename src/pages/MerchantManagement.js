      ...
      <div className="subsection">
        ...
        <div className="content-text">
          ...
          <div style={accordionContainerStyle}>
            ...
            {/* How to Download List of Merchants */}
            <div>
              <div style={accordionHeaderStyle(isDownloadOpen)} onClick={() => setIsDownloadOpen(!isDownloadOpen)}>
                <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Download List of Merchants:</span>
            ...
            {/* How to Create New Merchant */}
            <div>
              <div style={accordionHeaderStyle(isCreateOpen)} onClick={() => setIsCreateOpen(!isCreateOpen)}>
                <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Create New Merchant:</span>
              ...
              {isCreateOpen && (
                <div style={accordionBodyStyle}>
                  ...
                  <br/>
                  <div style={{ textAlign: 'center', marginBottom: '10px' }}>
                    <img src={newMerchantPage} alt="New Merchant Pages" style={{ border: '1px solid #ccc', padding: '5px', borderRadius: '4px', width: '100%' }} />
                  ...
                  <p>
                    For more information, click on{' '}
                    <button
                      onClick={(e) => { e.stopPropagation(); setIsNewMerchantPopupVisible(true); }}
                      style={{ cursor: 'pointer', color: 'blue', textDecoration: 'underline', background: 'none', border: 'none', padding: 0, font: 'inherit' }}
                    >
                      Field Details
                    </button>.
                  ...
                  {isNewMerchantPopupVisible && (
                    <>
                      <div style={popupOverlayStyle} onClick={() => setIsNewMerchantPopupVisible(false)} />
                      <div style={popupBoxStyle}>
                        <table className="command-syntax-table" style={{ marginTop: '10px' }}>
                          <thead>
                            <tr><th colSpan="2" style={{ textAlign: 'center' }}>Field Details</th></tr>
                          ...
                          <tbody>
                            <tr><td>Field Name:</td><td><strong>Institution Code - Institution Name</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the institution the merchant is belong to.</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                            <tr><td>Field Name:</td><td><strong>Bill Code</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the ID of the merchant.</td></tr>
                            <tr><td>Type:</td><td>Alphanumeric</td></tr>
                            <tr><td>Length:</td><td>2</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                            <tr><td>Field Name:</td><td><strong>Merchant Initials</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the alias/initials of specific merchant.</td></tr>
                            <tr><td>Type:</td><td>Alphanumeric</td></tr>
                            <tr><td>Maximum Length:</td><td>3</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                            <tr><td>Field Name:</td><td><strong>Merchant Name</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the name of the merchant.</td></tr>
                            <tr><td>Type:</td><td>Alphanumeric</td></tr>
                            <tr><td>Maximum Length:</td><td>30</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                            <tr><td>Field Name:</td><td><strong>Contact Person</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the contact person of merchant.</td></tr>
                            <tr><td>Type:</td><td>Alphanumeric</td></tr>
                            <tr><td>Maximum Length:</td><td>30</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                            <tr><td>Field Name:</td><td><strong>Contact Number 1</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the primary contact number of the merchant.</td></tr>
                            <tr><td>Type:</td><td>Numeric</td></tr>
                            <tr><td>Maximum Length:</td><td>20</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                            <tr><td>Field Name:</td><td><strong>Contact Number 2</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the secondary contact number of the merchant.</td></tr>
                            <tr><td>Type:</td><td>Numeric</td></tr>
                            <tr><td>Maximum Length:</td><td>20</td></tr>
                            <tr><td>Field Name:</td><td><strong>Address</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the address of the merchant.</td></tr>
                            <tr><td>Type:</td><td>Alphanumeric</td></tr>
                            <tr><td>Maximum Length:</td><td>128</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                            <tr><td>Field Name:</td><td><strong>Email Address</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the email address of the merchant.</td></tr>
                            <tr><td>Type:</td><td>Alphanumeric; Formatted field (xxxx@xxx.com)</td></tr>
                            <tr><td>Maximum Length:</td><td>32</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                            <tr><td>Field Name:</td><td><strong>Start Time</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the access start time of the merchant.</td></tr>
                            <tr><td>Type:</td><td>Time</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                            <tr><td>Field Name:</td><td><strong>End Time</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the access end time of the merchant.</td></tr>
                            <tr><td>Type:</td><td>Time</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                            <tr><td>Field Name:</td><td><strong>Settlement Time</strong></td></tr>
                            <tr><td>Definition:</td><td>Refers to the time of settlement on the daily single transactions.</td></tr>
                            <tr><td>Type:</td><td>Time</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                            {['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'].map(day => (
                              <React.Fragment key={day}>
                                <tr><td>Field Name:</td><td><strong>{day}</strong></td></tr>
                                <tr><td>Definition:</td><td>Day the merchant is available to access the application.</td></tr>
                                <tr><td>Type:</td><td>Boolean</td></tr>
                                <tr><td>Dependency:</td><td>Required field</td></tr>
                              </React.Fragment>
                            ))}
                            <tr><td>Field Name:</td><td><strong>Status</strong></td></tr>
                            <tr><td>Definition:</td><td>Merchant status whether it is active or inactive.</td></tr>
                            <tr><td>Type:</td><td>Boolean</td></tr>
                            <tr><td>Dependency:</td><td>Required field</td></tr>
                          </tbody>
                        </table>
            ...
            {/* How to Update Merchant */}
            <div>
              <div style={accordionHeaderStyle(isUpdateOpen)} onClick={() => setIsUpdateOpen(!isUpdateOpen)}>
                <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Update Merchant:</span>
            ...
            {/* How to Delete Merchant */}
            <div>
              <div style={accordionHeaderStyle(isDeleteOpen)} onClick={() => setIsDeleteOpen(!isDeleteOpen)}>
                <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Delete Merchant in Edit Merchant Page:</span>
            ...
            {/* How to Delete Multiple Merchants */}
            <div>
              <div style={{ ...accordionHeaderStyle(isDeleteMultipleOpen), borderBottom: isDeleteMultipleOpen ? '1px solid #ddd' : 'none' }} onClick={() => setIsDeleteMultipleOpen(!isDeleteMultipleOpen)}>
                <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Delete Multiple Merchants:</span>
                <span style={chevronStyle(isDeleteMultipleOpen)}>&#8964;</span>
              </div>
              {isDeleteMultipleOpen && (
                <div style={{ ...accordionBodyStyle, borderBottom: 'none' }}>
                  <ol style={{ marginLeft: '20px' }}>
                    <li>In <u><b>Manage Merchant</b></u>. Select merchants on the list by clicking rows.</li>
                    <li>
                      Click{' '}
                      <button style={{ backgroundColor: '#FFD700', border: '1px solid #ccc', padding: '2px 6px', borderRadius: '4px' }}>Delete</button>{' '}
                    ...
                    <li>A transaction receipt is displayed signifying that the transactions is for approval.</li>
                  </ol>
