        ...
        <div style={accordionContainerStyle}>
          ...
          <div>
            <div style={accordionHeaderStyle(isSubmitOpen)} onClick={() => setIsSubmitOpen(!isSubmitOpen)}>
              <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Submit Partial Billing File for Approval:</span>
              ...
              <div style={accordionBodyStyle}>
                <ol style={{ marginLeft: '20px' }}>
                  ...
                  <li>
                    ...
                    <i className="fas fa-download" style={{ fontSize: '16px', color: '#000', margin: '0 4px' }}></i>{' '}
                    button to check the available raw partial billing file uploaded.
                  </li>
                  <li>
                    Click the{' '}
                    <i className="fas fa-download" style={{ fontSize: '16px', color: '#000', margin: '0 4px' }}></i>{' '}
                    button beside the partial billing file. A confirmation dialog box is displayed that summarizes the raw billing file. Click{' '}
          ...
          <div>
            <div style={accordionHeaderStyle(isUpdateOpen)} onClick={() => setIsUpdateOpen(!isUpdateOpen)}>
              <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Update the Details of Scheduled Billing Files:</span>
          ...
          <div>
            <div style={accordionHeaderStyle(isDeleteOpen)} onClick={() => setIsDeleteOpen(!isDeleteOpen)}>
              <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Delete Billing File Individually:</span>
              ...
              <div style={accordionBodyStyle}>
                <ol style={{ marginLeft: '20px' }}>
                  ...
                  <li>
                    ...
                    button. After clicking the <b>Delete</b> button, a confirmation dialog box is displayed. Click{' '}
                    <button style={{ backgroundColor: '#FFD700', border: '1px solid #ccc', padding: '2px 6px', borderRadius: '4px' }}>Yes</button>{' '}
                    to continue and{' '}
                    <button style={{ backgroundColor: '#FFD700', border: '1px solid #ccc', padding: '2px 6px', borderRadius: '4px' }}>No</button>{' '}
                    if otherwise.
          ...
          <div>
            <div style={{ ...accordionHeaderStyle(isDeleteMultipleOpen), borderBottom: isDeleteMultipleOpen ? '1px solid #ddd' : 'none' }} onClick={() => setIsDeleteMultipleOpen(!isDeleteMultipleOpen)}>
              <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Delete Multiple Billing Files:</span>
