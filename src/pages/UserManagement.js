    ...
    <div className="content-section">
      <div className="subsection">
        ...
        <div className="content-text">
          <p>
            <i>User Management</i> handles the administration of System Users, their Roles, Privileges and Merchant Assignment. Only users with a System Administrator and User Admin role type can access these modules.
          </p>
          <br/>
          ...
          <div style={accordionContainerStyle}>
            ...
            <div>
              <div style={accordionHeaderStyle(isDownloadOpen)} onClick={() => setIsDownloadOpen(!isDownloadOpen)}>
                <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Download List of Users:</span>
            ...
            <div>
              <div style={accordionHeaderStyle(isCreateOpen)} onClick={() => setIsCreateOpen(!isCreateOpen)}>
                <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Create New Users:</span>
              ...
              {isCreateOpen && (
                <div style={accordionBodyStyle}>
                  ...
                  <p>
                    ...
                    <button
                      type="button"
                      onClick={(e) => { e.stopPropagation(); setIsNewUserPopupVisible(true); }}
            ...
            <div>
              <div style={accordionHeaderStyle(isUpdateOpen)} onClick={() => setIsUpdateOpen(!isUpdateOpen)}>
                <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Update User:</span>
            ...
            <div>
              <div style={accordionHeaderStyle(isDeleteOpen)} onClick={() => setIsDeleteOpen(!isDeleteOpen)}>
                <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Delete a User:</span>
            ...
            <div>
              <div style={accordionHeaderStyle(isDeleteMultipleOpen)} onClick={() => setIsDeleteMultipleOpen(!isDeleteMultipleOpen)}>
                <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Delete Multiple Users:</span>
            ...
            <div>
              <div style={{ ...accordionHeaderStyle(isForceChangeOpen), borderBottom: isForceChangeOpen ? '1px solid #ddd' : 'none' }} onClick={() => setIsForceChangeOpen(!isForceChangeOpen)}>
                <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Force Change User Password:</span>
                <span style={chevronStyle(isForceChangeOpen)}>&#8964;</span>
              </div>
              {isForceChangeOpen && (
                <div style={{ ...accordionBodyStyle, borderBottom: 'none' }}>
                  <ol style={{ marginLeft: '20px' }}>
                    ...
                    <li>A transaction receipt is displayed signifying that the transaction is posted to user's email address.</li>
                  </ol>
                  <p>
                  ...
                  <p>
                    ...
                    <button
                      type="button"
                      onClick={(e) => { e.stopPropagation(); setIsChangePasswordPopupVisible(true); }}
                      style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', color: 'blue', textDecoration: 'underline' }}>
                      Field Details
                    </button>.
                  </p>
