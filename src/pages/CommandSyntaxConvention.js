...
const CommandSyntaxConvention = () => {
  return (
    <div className="content-section">

      <div className="section-title" style={{ fontSize: '22px' }}>1.3 CONVENTION</div>

      <div className="subsection">
        <div className="subsection-title">1.3.2 COMMAND SYNTAX CONVENTION</div>
...
export default CommandSyntaxConvention;