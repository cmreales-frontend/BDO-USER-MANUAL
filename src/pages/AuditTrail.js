  ...
  return (
    <div className="content-section">
      ...
      <div style={accordionContainerStyle}>
        <div>
          <div style={{ ...accordionHeaderStyle(isOpen), borderBottom: isOpen ? '1px solid #ddd' : 'none' }} onClick={() => setIsOpen(!isOpen)}>
            <span style={{ fontSize: '15px', fontWeight: '500' }}>How to Download Audit Trail Reports:</span>
