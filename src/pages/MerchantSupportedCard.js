        ...
        <div className="content-text">
          ...
          <table className="command-syntax-table" style={{ marginTop: '10px' }}>
            ...
            <tbody>
              ...
              <tr>
                <td>Definition:</td>
                <td>Field query input for the List of Supported Card table to retrieve related information on below listing.</td>
              </tr>
              <tr>
                <td>Type:</td>
                <td>Alphanumeric</td>
          ...
          <ol style={{ marginLeft: '20px' }}>
            ...
            <li>
              ...
              button to submit the transaction. A confirmation dialog box is displayed (see <i>Figure 4.18</i>).
              Click{' '}
              <button style={{ backgroundColor: '#FFD700', border: '1px solid #ccc', padding: '2px 6px', borderRadius: '4px' }}>Yes</button>{' '}
              to continue and{' '}
              <button style={{ backgroundColor: '#FFD700', border: '1px solid #ccc', padding: '2px 6px', borderRadius: '4px' }}>No</button>{' '}
